...
# AtCoder 표준 기본값. 문제별 실제 제한은 DB에 아직 없어(problems 테이블 미확정 범위) 고정값 사용.
...
def _verdict_for(result: Judge0Result, expected_output: str) -> Optional[str]:
...
def judge_submission(
    *, code: str, language: str, problem_source: str, client: Judge0Client
) -> JudgeOutcome:
